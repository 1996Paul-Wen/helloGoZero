    ...
    <div class="glass rounded-3xl shadow-2xl w-full max-w-md p-10">
      ...
      <el-form :model="form" :rules="rules" ref="formRef" @submit.prevent="handleRegister">
        <el-form-item prop="name" class="!mb-5">
          <div class="flex items-center gap-3">
            ...
            <input
              ...
              type="text"
              placeholder="请设置用户名"
              class="flex-1 px-4 py-2.5 rounded-xl border border-slate-200 bg-white/60 focus:bg-white focus:border-emerald-400 focus:ring-2 focus:ring-emerald-100 outline-none transition-all text-sm"
        ...
        <el-form-item prop="confirmPassword" class="!mb-5">
          <div class="flex items-center gap-3">
            <label class="text-sm font-medium text-slate-700 w-14 text-right shrink-0">确认密码</label>
            <input
